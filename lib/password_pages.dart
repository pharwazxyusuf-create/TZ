...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  Future<void> send() async {
    ...
    try {
      ...
      if (mounted) ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Unable to connect. Please check your internet connection and try again.')));
    } finally {
