...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  Future<void> send() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Unable to connect. Please check your internet connection and try again.')),
        );
      }
    } finally {
              ...
              children: [
                ...
                Text(
                  sent
                      ...
                      : 'Enter your registered TZ email and we will send you a secure reset link.',
...
class _ChangePasswordPageState extends State<ChangePasswordPage> {
  ...
  Future<void> save() async {
    if (password.text.length < 8 || password.text != confirm.text) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Passwords must match and contain at least 8 characters.')),
      );
      return;
    }
